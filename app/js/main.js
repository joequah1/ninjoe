...
/* ================================= */
  ...
  var latitude = 3.0561764,
    longitude = 101.5550913,
    map_zoom = 9;
 ...
 var contentString = '<div class="contact-box left">'+
      '<h3>CONTACT INFORMATION.</h3>'+
         '<ul>'+
       '<li><i class="fa fa-fw fa-map-marker"></i>V12 Sovo, Malaysia</li>'+
       '<li><i class="fa fa-fw fa-phone"></i>+6010-504-7717</li>'+
       '<li><i class="fa fa-fw fa-envelope-o"></i><a href="mailto:">joequah1@gmail.com</a></li>'+
       '<li><i class="fa fa-fw fa-globe"></i><a href="">ninjoe.org</a></li>'+
       '</ul>'+
      '</div>';
